...
import { createGroup, getUsers } from "@/lib/actions"
...
export default function CreateGroup() {
    ...
    const handleCreateGroup = async (formData: FormData) => {
        ...
        try {
            ...
            const result = await createGroup(name, userList)
...
<div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create Group</h2>
    </div>
            <form className="space-y-6" action={handleCreateGroup}>
                <div>
                ...
                <div>
                    ...
                    <select multiple name="users" id="users" className="border p-2 w-full" data-testid="author-dropdown">
